...
export default function ServicesSection({
  ...
  // ==========================================
  // SHOW ONLY 3 ON HOME PAGE
  // SHOW ALL ON ROUTES PAGE
  // ==========================================
      ...
      <div className="section-container">
        ...
        >
          ...
          <p className="mt-4 text-sm leading-7 text-[var(--color-muted)] lg:text-base">
            Discover premium travel planning for luxury escapes,
            cultural adventures, and relaxing retreats built around
            your lifestyle.
          </p>
        </motion.div>
